            ...
            <div v-if="currentStepType === 'comment'">
                ...
                <div class="mt-6">
                    ...
                    <div class="flex gap-2">
                        <button
                            @click="commentCameraInput.click()"
                            class="flex flex-1 items-center justify-center gap-2 rounded-xl border-2 border-dashed border-gray-200 bg-white py-3 text-sm font-medium text-gray-500 active:bg-gray-50 dark:border-gray-700 dark:bg-gray-900 dark:text-gray-400 dark:active:bg-gray-800"
                        >
