<template>
    <!-- Вариант N: Service Flow — полный цикл обслуживания, пошаговая форма -->
    <div class="flex min-h-screen flex-col bg-gray-50 dark:bg-gray-950">
        ...
        <header class="flex items-center gap-3 bg-white px-4 py-3 shadow-sm dark:bg-gray-900">
            ...
            <div class="flex-1 min-w-0">
                <p class="text-sm font-bold text-gray-900 truncate dark:text-white">{{ point.name }}</p>
                <p class="text-xs text-gray-400 truncate dark:text-gray-500">{{ point.address }}</p>
            </div>
                ...
                <div v-if="currentStep === 1" key="step1">
                    ...
                    <div class="mb-6 rounded-2xl bg-white p-4 shadow-sm dark:bg-gray-900">
                        ...
                        <div class="relative mx-auto mb-4 h-32 w-16">
                            ...
                            <div class="absolute inset-x-0 bottom-0 h-28 rounded-b-xl rounded-t-md border-2 border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 overflow-hidden">
                                <div
                                    class="absolute inset-x-0 bottom-0 rounded-b-lg bg-blue-400/30 transition-all duration-300 dark:bg-blue-500/30"
                                    :style="{ height: (water.main * 100) + '%' }"
                                >
                    ...
                    <div class="rounded-2xl bg-white p-4 shadow-sm dark:bg-gray-900">
                        ...
                        <div class="relative mx-auto mb-4 h-32 w-16">
                            <div class="absolute inset-x-0 bottom-0 h-28 rounded-b-xl rounded-t-md border-2 border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800 overflow-hidden">
                                <div
                                    class="absolute inset-x-0 bottom-0 rounded-b-lg bg-cyan-400/30 transition-all duration-300 dark:bg-cyan-500/30"
                                    :style="{ height: (water.spare * 100) + '%' }"
                                >
                            ...
                            <div class="flex items-center justify-between gap-4">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        <button
                                            class="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-100 text-gray-600 active:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:active:bg-gray-700 transition-colors"
                                            @click="ing.brought = Math.max(0, ing.brought - 1)"
                                        >
                                        ...
                                        <button
                                            class="flex h-8 w-8 items-center justify-center rounded-lg bg-green-100 text-green-700 active:bg-green-200 dark:bg-green-900/40 dark:text-green-400 dark:active:bg-green-900/60 transition-colors"
                                            @click="ing.brought++"
                                        >
                                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                ...
                                <div class="flex-1">
                                    ...
                                    <div class="flex items-center justify-center gap-2">
                                        <button
                                            class="flex h-8 w-8 items-center justify-center rounded-lg bg-gray-100 text-gray-600 active:bg-gray-200 dark:bg-gray-800 dark:text-gray-300 dark:active:bg-gray-700 transition-colors"
                                            @click="ing.needed = Math.max(0, ing.needed - 1)"
                                        >
                                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M5 12h14" />
                                            </svg>
                                        ...
                                        <button
                                            class="flex h-8 w-8 items-center justify-center rounded-lg bg-orange-100 text-orange-700 active:bg-orange-200 dark:bg-orange-900/40 dark:text-orange-400 dark:active:bg-orange-900/60 transition-colors"
                                            @click="ing.needed++"
                                        >
                                            <svg class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                                                <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    ...
                    <div class="space-y-4">
                        ...
                        <div
                            ...
                            :class="photos.inside
                                ...
                                : 'border-gray-200 dark:border-gray-700 active:border-blue-300 dark:active:border-blue-700'"
                            ...
                            <template v-else>
                                <div class="flex h-full w-full items-center justify-center rounded-2xl bg-green-50 dark:bg-green-900/20">
                                    <div class="text-center">
                                        ...
                                        <p class="mt-1 text-xs text-green-500/70">Нажмите для замены</p>
                                    </div>
                                </div>
                            </template>
                        </div>
        ...
        <div class="fixed inset-x-0 bottom-0 border-t border-gray-200 bg-white px-4 pb-6 pt-4 dark:border-gray-800 dark:bg-gray-900">
            ...
            <button
                ...
                :class="currentStep === totalSteps
                    ? 'bg-green-500 active:bg-green-600 shadow-green-500/25'
                    : 'bg-blue-500 active:bg-blue-600 shadow-blue-500/25'"
                @click="nextStep"
            >
...
const ingredients = reactive([
    { name: 'Кофе', icon: '\u2615', bgClass: 'bg-amber-100 dark:bg-amber-900/30', brought: 0, needed: 2 },
    { name: 'Молоко', icon: '\uD83E\uDD5B', bgClass: 'bg-blue-100 dark:bg-blue-900/30', brought: 0, needed: 1 },
    { name: 'Сахар', icon: '\uD83E\uDDC2', bgClass: 'bg-yellow-100 dark:bg-yellow-900/30', brought: 0, needed: 0 },
    { name: 'Шоколад', icon: '\uD83C\uDF6B', bgClass: 'bg-orange-100 dark:bg-orange-900/30', brought: 0, needed: 3 },
    { name: 'Стаканы', icon: '\uD83E\uDD64', bgClass: 'bg-gray-100 dark:bg-gray-800', brought: 0, needed: 1 },
    { name: 'Крышки', icon: '\u26AB', bgClass: 'bg-gray-100 dark:bg-gray-800', brought: 0, needed: 1 },
